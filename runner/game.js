(() => {
  ...
  function setScreen(screen) {
    state.screen = screen;
    [startScreen, countdownScreen, pauseScreen, gameOverScreen].forEach((panel) => panel.classList.remove('active'));
    if (screen === 'start') startScreen.classList.add('active');
    if (screen === 'countdown') countdownScreen.classList.add('active');
    if (screen === 'paused') pauseScreen.classList.add('active');
    if (screen === 'over') gameOverScreen.classList.add('active');
  }
